...
contract FarmingC2M is Ownable {
    ...
    constructor(IERC20 _erc20, uint256 _rewardPerSecond, uint256 _startTimestamp) Ownable(msgSender) {
        erc20 = _erc20;
    ...
    function pending(uint256 _pid, address _user) external view returns (uint256) {
        ...
        if (block.timestamp > pool.lastRewardTimestamp && lpSupply != 0) {
            ...
            require(totalAllocPoint > 0, "Total allocation point cannot be zero");
            ...
            require(lpSupply > 0, "LP supply cannot be zero");
    ...
    function updatePool(uint256 _pid) public {
        ...
        require(totalAllocPoint > 0, "Total alloc point cannot be zero");
        uint256 erc20Reward = (nrOfSeconds * rewardPerSecond) * pool.allocPoint / totalAllocPoint;
